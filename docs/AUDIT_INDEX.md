...
EP-005 remains active because Phase 4 also requires CI evidence ingestion, merge approval policy, expected-head merge protection, and serial post-merge acceptance. The next governed track is CI evidence ingestion.

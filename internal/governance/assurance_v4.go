...
var frozenScenarioRows = []string{
	...
	"AG-S-066|SECURITY_PRIVACY_BOUNDARY|a fresh bootstrap lacks a function body/wire, definer `current_user` breaks domain lookup, a function bypasses forced RLS, or another runtime domain is accessed|AG-I18,AG-I22,AG-I35|AG-PO-046,AG-PO-060",
